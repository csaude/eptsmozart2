...
VALUES('FORM', 'FORM_ID', '37', 'ADULTO: SEGUIMENTO', 'RETIRED'),
('FORM', 'FORM_ID', '44', 'PEDIATRIA: SEGUIMENTO', 'RETIRED'),
('FORM', 'FORM_ID', '60', 'LABORATORIO GERAL-V2008', 'RETIRED'),
('FORM', 'FORM_ID', '62', 'TARV: RASTREIO DE TUBERCULOSE', 'RETIRED'),
('FORM', 'FORM_ID', '67', 'ADULTO: PROCESSO PARTE A - ANAMNESE', 'RETIRED'),
('FORM', 'FORM_ID', '68', 'PEDIATRIA: PROCESSO PARTE A - ANAMNESE', 'RETIRED'),
...
('FORM', 'FORM_ID', '138', 'FORMULÁRIO DE VISITA DOMICILIÁRIA', ''),
...
('PATIENT_STATE', 'SOURCE_ID', '163', 'FICHA CLINICA', ''),
...
('MEDICATION','REASON_CHANGE_REGIMEN_ID','5622','OUTRO, NAO CODIFICADO', ''),
('MEDICATION','REASON_CHANGE_REGIMEN_ID','23744','NOVO MEDICAMENTO DISPONIVEL', ''),
('MEDICATION','REASON_CHANGE_REGIMEN_ID','23745','RUPTURA DE ESTOCK DE ARV', ''),
...
('DSD','DSD_ID','23727','PARAGEM ÚNICA (PU)', ''),
('DSD','DSD_ID','23731','DISPENSA COMUNITÁRIA (DC)', ''),
('DSD','DSD_ID','165340','DISPENSA BIMENSAL', ''),
...
('TB_DATA', 'TB_SYMPTOM', '1065', 'YES', ''),
('TB_DATA', 'TB_SYMPTOM', '1066', 'NO', ''),
('TB_DATA', 'SYMPTOM_FEVER', '1763', 'FEVER', ''),
('TB_DATA', 'SYMPTOM_WEIGHT_LOSS', '1764', 'WEIGHT LOSS', ''),
('TB_DATA', 'SYMPTOM_NIGHT_SWEAT', '1762', 'NIGHT SWEATS', ''),
('TB_DATA', 'SYMPTOM_COUGH', '1760', 'COUGH', ''),
('TB_DATA', 'SYMPTOM_ASTHENIA',	'23760', 'ASTHENIA', ''),
('TB_DATA', 'SYMPTOM_TB_CONTACT', '1765', 'TB CONTACT', ''),
('TB_DATA', 'SYMPTOM_ADENOPATHY', '161', 'ADENOPATHY', ''),
('TB_DATA', 'TB_DIAGNOSE', '1065', 'YES', ''),
('TB_DATA', 'TB_DIAGNOSE', '1066', 'NO', ''),
('TB_DATA', 'TB_TREATMENT',	'1256',	'START', ''),
('TB_DATA', 'TB_TREATMENT',	'1257',	'CONTINUE', ''),
('TB_DATA', 'TB_TREATMENT',	'1267',	'COMPLETED', ''),
('PROPHYLAXIS', 'REGIMEN_PROPHYLAXIS', '656', 'ISONIAZID', ''),
('PROPHYLAXIS', 'REGIMEN_PROPHYLAXIS', '23954',	'3HP', ''),
('PROPHYLAXIS', 'REGIMEN_PROPHYLAXIS', '165305', '1HP', ''),
('PROPHYLAXIS', 'REGIMEN_PROPHYLAXIS', '165306', 'LFX', ''),
('PROPHYLAXIS', 'REGIMEN_PROPHYLAXIS', '23982', 'Isoniazid + Pyridoxine', ''),
('PROPHYLAXIS', 'REGIMEN_PROPHYLAXIS', '23983',	'Levofloxacin + Pyridoxine', ''),
('PROPHYLAXIS', 'REGIMEN_PROPHYLAXIS', '23984', '3HP + Pyridoxine', ''),
('PROPHYLAXIS', 'REGIMEN_PROPHYLAXIS', '916', 'COTRIMOXAZOL', ''),
('PROPHYLAXIS', 'REGIMEN_PROPHYLAXIS', '165214', 'TDF/3TC', ''),
('PROPHYLAXIS', 'REGIMEN_PROPHYLAXIS', '165215', 'TDF/FTC', ''),
('PROPHYLAXIS', 'PROPHYLAXIS_STATUS', '1256', 'START', ''),
('PROPHYLAXIS', 'PROPHYLAXIS_STATUS', '1257', 'CONTINUE', ''),
('PROPHYLAXIS', 'PROPHYLAXIS_STATUS', '1267', 'COMPLETED', ''),
('PROPHYLAXIS', 'PROPHYLAXIS_STATUS', '1705', 'RESTART', ''),
('PROPHYLAXIS', 'SECONDARY_EFFECT',	'1065',	'YES', ''),
('PROPHYLAXIS', 'SECONDARY_EFFECT',	'1066',	'NO', ''),
('PROPHYLAXIS', 'DISPENSATION_TYPE', '1098', 'MONTHLY', ''),
('PROPHYLAXIS', 'DISPENSATION_TYPE', '23720', 'QUARTERLY', ''),
('STI',	'STI_CONCEPT_ID', '6258', 'SCREENING FOR STI', ''),
('STI',	'STI_CONCEPT_ID', '174', 'STI', ''),
('STI',	'STI_VALUE', '1065', 'YES', ''),
('STI',	'STI_VALUE', '1066', 'NO', ''),
('STI',	'STI_VALUE', '223',	'SIFILIS', ''),
('STI',	'STI_VALUE', '5993', 'VAGINAL DISCHARGE', ''),
('STI',	'STI_VALUE', '5995', 'URETHRAL DISCHARGE', ''),
('STI',	'STI_VALUE', '864',	'GENITAL SORES', ''),
('STI',	'STI_VALUE', '902',	'PELVIC INFLAMMATORY DISEASE', ''),
('STI',	'STI_VALUE', '12611', 'INFLAMMATORY DISORDER OF THE SCROTUM', ''),
('STI',	'STI_VALUE', '6747', 'GRANULOMA INGUINALE', ''),
('FAMILY_PLANNING',	'FP_CONCEPT_ID', '374',	'METHOD OF FAMILY PLANNING', ''),
('FAMILY_PLANNING',	'FP_METHOD', '1107', 'NONE', ''),
('FAMILY_PLANNING',	'FP_METHOD', '190', 'CONDOMS', ''),
('FAMILY_PLANNING',	'FP_METHOD', '780',	'ORAL CONTRACEPTION', ''),
('FAMILY_PLANNING',	'FP_METHOD', '5279', 'INJECTABLE CONTRACEPTIVES', ''),
('FAMILY_PLANNING',	'FP_METHOD', '21928', 'IMPLANT', ''),
('FAMILY_PLANNING',	'FP_METHOD', '5275', 'INTRAUTERINE DEVICE', ''),
('FAMILY_PLANNING', 'FP_METHOD', '5275', 'INTRAUTERINE DEVICE', ''),
('FAMILY_PLANNING', 'FP_METHOD', '5276', 'FEMALE STERILIZATION', ''),
('FAMILY_PLANNING', 'FP_METHOD', '23714', 'VASECTOMY', ''),
('FAMILY_PLANNING', 'FP_METHOD', '23715', 'LACTATIONAL AMENORRHEA METHOD', ''),
('COUNSELING', 'DIAGNOSIS_REVEAL', '6339', 'NOT REVEALED', ''),
('COUNSELING', 'DIAGNOSIS_REVEAL', '6338', 'PARTIALLY REVEALED', ''),
('COUNSELING', 'DIAGNOSIS_REVEAL', '6337', 'REVEALED', ''),
('COUNSELING', 'HIV_DISCLOSURE', '1065', 'YES', ''),
('COUNSELING', 'HIV_DISCLOSURE', '1066', 'NO', ''),
('COUNSELING', 'ADHERENCE_PLAN', '1065', 'YES', ''),
('COUNSELING', 'ADHERENCE_PLAN', '1066', 'NO', ''),
('COUNSELING', 'SECONDARY_EFFECTS', '1065', 'YES', ''),
('COUNSELING', 'SECONDARY_EFFECTS', '1066', 'NO', ''),
('COUNSELING', 'ADHERENCE_ART', '1383', 'GOOD', ''),
('COUNSELING', 'ADHERENCE_ART', '1749', 'RISK', ''),
('COUNSELING', 'ADHERENCE_ART', '1385', 'BAD', ''),
('COUNSELING', 'CONSULTATION_REASON', '1115', 'NORMAL', ''),
('COUNSELING', 'CONSULTATION_REASON', '6311', 'PURE ADHERENCE', ''),
('COUNSELING', 'CONSULTATION_REASON', '1707', 'LTFU', ''),
('COUNSELING', 'ACCEPT_CONTACT', '1065', 'YES', ''),
('COUNSELING', 'ACCEPT_CONTACT', '1066', 'NO', ''),
('COUNSELING', 'PSYCHOSOCIAL_REFUSAL', '1956', 'DOES NOT BELIEVE TEST RESULTS', ''),
('COUNSELING', 'PSYCHOSOCIAL_SICK', '1936', 'PATIENT FEELS SICK', ''),
('COUNSELING', 'PSYCHOSOCIAL_NOTBELIEVE', '6186', 'DOES NOT BELIEVE ARV TREATMENT', ''),
('COUNSELING', 'PSYCHOSOCIAL_LOTOFPILLS', '23766', 'THERE ARE MANY TABLETS', ''),
('COUNSELING', 'PSYCHOSOCIAL_FEELBETTER', '23767', 'FEEL BETTER', ''),
('COUNSELING', 'PSYCHOSOCIAL_LACKFOOD', '18698', 'LACK OF FOOD', ''),
('COUNSELING', 'PSYCHOSOCIAL_LACKSUPPORT', '2153', 'HAS LACK OF SUPPORT', ''),
('COUNSELING', 'PSYCHOSOCIAL_DEPRESSION', '207', 'DEPRESSION', ''),
('COUNSELING', 'PSYCHOSOCIAL_NOTREVEAL', '2155', 'NOT REVEALED HIS HIV STATUS', ''),
('COUNSELING', 'PSYCHOSOCIAL_TOXICITY', '2015', 'ARV TREATMENT SIDE EFFECTS', ''),
('COUNSELING', 'PSYCHOSOCIAL_LOSTPILLS', '23768', 'LOST / FORGOT / SHARED TABLETS', ''),
('COUNSELING', 'PSYCHOSOCIAL_STIGMA', '6436', 'STIGMA', ''),
('COUNSELING', 'PSYCHOSOCIAL_TRASPORT', '820', 'TRANSPORT PROBLEMS', ''),
('COUNSELING', 'PSYCHOSOCIAL_GBV', '6303', 'GENDER BASED VIOLENCE', ''),
('COUNSELING', 'PSYCHOSOCIAL_CULTURAL', '23769', 'CULTURAL OR TRADITIONAL ASPECTS', ''),
('COUNSELING', 'PSYCHOSOCIAL_DRUGUSE', '1603', 'ALCOHOL USE', ''),
('COUNSELING', 'PP1', '1065', 'YES', ''),
('COUNSELING', 'PP1', '1066', 'NO', ''),
('COUNSELING', 'PP2', '1065', 'YES', ''),
('COUNSELING', 'PP2', '1066', 'NO', ''),
('COUNSELING', 'PP3', '1065', 'YES', ''),
('COUNSELING', 'PP3', '1066', 'NO', ''),
('COUNSELING', 'PP4', '1065', 'YES', ''),
('COUNSELING', 'PP4', '1066', 'NO', ''),
('COUNSELING', 'PP5', '1065', 'YES', ''),
('COUNSELING', 'PP5', '1066', 'NO', ''),
('COUNSELING', 'PP6', '1065', 'YES', ''),
('COUNSELING', 'PP6', '1066', 'NO', ''),
('COUNSELING', 'PP7', '1065', 'YES', ''),
('COUNSELING', 'PP7', '1066', 'NO', ''),
('COUNSELING', 'KEYPOP_LUBRICANTS', '1065', 'YES', ''),
('COUNSELING', 'KEYPOP_LUBRICANTS', '1066', 'NO', '')