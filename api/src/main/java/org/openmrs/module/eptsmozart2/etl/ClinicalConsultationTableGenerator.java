...
public class ClinicalConsultationTableGenerator extends AbstractGenerator {
	...
	protected String countQuery() {
		StringBuilder sb = new StringBuilder("SELECT COUNT(*) FROM ")
				...
				.append(SCHEDULED_DATE_CONCEPT).append(" WHERE !e.voided AND e.encounter_type IN ").append(inClause(ENCOUNTER_TYPE_IDS))
				.append(" AND e.location_id IN (").append(AppProperties.getInstance().getLocationsIdsString()).append(")");
		return sb.toString();
	}
